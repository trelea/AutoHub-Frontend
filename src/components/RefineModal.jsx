...
export const RefineModal = ({ setRefineModal }) => {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 h-screen w-screen z-50 flex flex-col justify-between">
            <div className="bg-slate-50 w-full p-4 flex flex-col gap-4 border-b border-gray-300">
                <div className="flex justify-between items-center">
                    ...
                    <button type="button" onClick={() => {
                        ...
                        <IoMdClose fontSize={'1.75rem'} className="text-gray-500"/>
                    </button>
                </div>
                <div className="flex justify-start">
                    <button type="button" className="btn btn-outline btn-primary rounded-full w-32 flex">
                         <RxReset fontSize={'1.25rem'}/> Reset
                    </button>
                </div>
            </div>
            
            <div className="bg-white h-max overflow-y-auto p-2">
                {/* Auction Source */}
            ...
            <div className="bg-slate-50 w-full p-4 border-t border-gray-300">
                <button type="button" className="btn btn-active btn-primary w-full rounded-full">Show vehicles</button>
            </div>
        </div>
    )
}
